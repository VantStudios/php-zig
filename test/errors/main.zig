...
const arginfo_throws_exception = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
};
...
fn php_throws_exception(
    ...
    _ = execute_data;
    _ = return_value;
    php.throwException("boom from zig", 42);
}

const arginfo_throws_error = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
};
...
fn php_throws_error(
    ...
    _ = execute_data;
    _ = return_value;
    php.throwError("fatal from zig");
}

const arginfo_throws_type_error = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
};
...
fn php_throws_type_error(
    ...
    _ = execute_data;
    _ = return_value;
    php.throwTypeError("expected int, got string");
}

const arginfo_throws_value_error = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
};
...
fn php_throws_value_error(
    ...
    _ = execute_data;
    _ = return_value;
    php.throwValueError("negative length");
}

const arginfo_emit_warning = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
    php.paramInfo("message", php.MAY_BE_STRING),
};
...
fn php_emit_warning(
    ...
    _ = return_value;
    const message = php.getArg(execute_data, 1) orelse return;
    const mv = message.toString() orelse return;
    php.phpError(php.E_WARNING, mv);
}

const arginfo_emit_notice = [_]php.zend_internal_arg_info{
    php.returnInfo(php.MAY_BE_NULL),
    php.paramInfo("message", php.MAY_BE_STRING),
};
