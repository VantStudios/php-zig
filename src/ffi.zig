...
pub const zend_hash_str_update = externDecl(
    *const fn (?*zend_array, [*:0]const u8, usize, ?*zval) callconv(.c) ?*zval,
    "zend_hash_str_update",
    "zend_hash_str_update@@32",
);
pub const zend_hash_str_find = externDecl(
    *const fn (?*const zend_array, [*:0]const u8, usize) callconv(.c) ?*zval,
    "zend_hash_str_find",
...
// Assign by string key (zend_API.h `add_assoc_*`). Keys must be
// null-terminated; lengths are passed separately for binary safety.
...
pub extern fn add_assoc_long_ex(zv: ?*zval, key: [*:0]const u8, key_len: usize, val: i64) c_int;
pub extern fn add_assoc_double_ex(zv: ?*zval, key: [*:0]const u8, key_len: usize, val: f64) c_int;
pub extern fn add_assoc_bool_ex(zv: ?*zval, key: [*:0]const u8, key_len: usize, val: c_int) c_int;
pub extern fn add_assoc_null_ex(zv: ?*zval, key: [*:0]const u8, key_len: usize) c_int;
pub extern fn add_assoc_zval_ex(zv: ?*zval, key: [*:0]const u8, key_len: usize, val: ?*zval) c_int;
